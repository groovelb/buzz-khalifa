...
> 로컬 적용: TSX·R3F·Tailwind를 유지하며 MUI는 문서 도구에 사용한다. 배치와 스토리 경로는 루트 `AGENTS.md`가 우선한다.
...
5. **구현**:
   - 루트 `AGENTS.md`와 `.claude/rules/code-style.md`에 따라 위치 결정
...
| `starterkit-overview.md` | 스타터킷 개요/맥락 (구 project-summary.md) | 온보딩/맥락 파악 시 |
